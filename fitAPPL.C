...
TSLA->SetTitle("APPL stock price");
...
TSLA->Draw("LA");
//////fit /////
TF1 *plotFun=new TF1("plotFun","129.461+x*(-1.27307e-06)+(x^2)*(5.68492e-14)+(x^3)*(-9.02653e-21)+(x^4)*(5.06863e-28)+(x^5)*(-1.28267e-35)+(x^6)*(1.74805e-43)+(x^7)*(-1.33266e-51)+(x^8)*(5.34718e-60)+(x^9)*(-8.78194e-69)",Time[0],Time[count-1]); //last 2 digits are the x range//
